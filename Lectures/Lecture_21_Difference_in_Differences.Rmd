---
title: "Lecture 21 Difference in Differences"
...
- Similar results if we look only at those without a HS degree, who the Cubanos would be competing with directly (wage DID `r round(means.le$lwage[4] - means.le$lwage[2] - (means.le$lwage[3] - means.le$lwage[1]),3)`, unemployment `r round(means.le$unemp[4] - means.le$unemp[2] - (means.le$unemp[3] - means.le$unemp[1]),3)`)
...
<small>*This is called the "parallel trends" assumption.</small>
